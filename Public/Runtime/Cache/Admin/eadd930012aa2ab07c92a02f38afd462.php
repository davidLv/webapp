	...
	<div id="index-main-portal">
		<div style="width:50%">
			<div title="我的个人信息" collapsible="true" style="padding:8px;line-height:1.8;height: 132px;">
				...
				最后登录时间：<?php if($userInfo['last_login_time'] > 0): echo (date('Y-m-d H:i:s',$userInfo["last_login_time"])); endif; ?><br />
				最后登录IP：<?php echo ($userInfo["last_login_ip"]); ?> <br />
			</div>
		...
		<div style="width:50%">
			...
			<div title="系统说明" collapsible="true" style="padding:8px;line-height:1.8">
				...
				<a href="http://doc.thinkphp.cn/">http://doc.thinkphp.cn/</a>（ThinkPHP开发手册）<br/>
				<a href="http://jeasyui.com/documentation/">http://jeasyui.com/documentation/</a>（EasyUI开发手册）><br/>
			</div>

			<div title="捐赠作者" collapsible="true" style="height: 260px;">
				<div class="easyui-tabs" data-options="fit:true,border:false,plain:true">
					<div title="支付宝捐赠" style="padding:8px;line-height:1.8">
						<img src="/app/Public/static/img/alipay.jpg"  alt="捐赠我们" height="155" /><br />
