...
window.baseModule = {
    ...
    tip: function(){
        $.messager.show({
            title:'登录提示',
            msg:'您好！<?php echo ($userInfo["user_name"]); ?> 欢迎回来！<br/>最后登录时间：<?php if($userInfo['last_login_time']): echo (date('Y-m-d H:i:s',$userInfo["last_login_time"])); else: ?>-<?php endif; ?><br/>最后登录IP：<?php echo ($userInfo["last_login_ip"]); ?>',
            timeout:5000,
            showType:'slide'
        });    
    },
