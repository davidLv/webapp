...
<script type="text/javascript" src="/app/Public/static/js/ckeditor/ckeditor.js"></script>
</head>
...
//	baseHref     : '/app/Public/upload/',
	...
	filebrowserImageUploadUrl : '<?php echo U("Upload/image");?>',
	filebrowserFlashUploadUrl : '<?php echo U("Upload/flash");?>',
	filebrowserUploadUrl      : '<?php echo U("Upload/link");?>',

	wordImagePasteApiUrl      : 'http://127.0.0.1:10101',  //建议端口大于10000
	imagePasteUploadEnabled   : true,
	imageRemoteUploadUrl      : '<?php echo U("Upload/remoteImage");?>',
	imageRemoteUploadBaseHref : '/app/Public/upload/'         //只用来过滤不用上传远程图片地址
});
