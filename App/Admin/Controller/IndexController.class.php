...
class IndexController extends CommonController {
    ...
    public function login(){
        ...
        if (I('get.dosubmit')){
            ...
            if (isset($_POST['verificationCode'])) {
                ...
                if ($verify->check($_POST['verificationCode'], 'admin')) {
                //if ($result == TRUE) {
    ...
    public function code(){
        ...
        if ($verify->imageW <= 0) $verify->imageW = 180;
    ...
    public function public_main(){
        ...
        $loginList = $admin_log->where(array('user_id'=>$userid))->order("time desc")->limit(5)->select();
